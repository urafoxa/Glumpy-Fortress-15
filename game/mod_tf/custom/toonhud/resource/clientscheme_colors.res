Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"156 64 62 255" // Highlight color
		...
		"G_LightGrey"			"206 199 199 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"211 211 215 161" // Transparent menu color
		...
		"G_MetalValue"			"206 199 199 255" // Metal color
		"G_MetalIcon"			"171 163 163 255" // Metal icon color
		"G_HeadsValue"			"72 236 28 255" // Heads value color
		"G_HeadsLabel"			"255 255 255 255" // Heads value icon color
		"G_KillstreakValue"		"227 158 27 255" // Killstreak value color
		"G_KillstreakIcon"		"205 214 48 255" // Killstreak icon color
		"G_StickyColor"					"219 34 34 255" // Stickybomb color
		"G_StickyIconColor"				"189 100 100 255" // Stickybomb icon color
		...
		"G_Killfeed_Local"			"255 155 0 255" // Killfeed Local color
		...
		"G_Footer"					"38 39 42 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"213 196 187 255" // Footer text color
		"G_DimmFooterText"			"213 196 187 120" // Dimm Footer text color
		...
		"G_MainMenuButton"			"29 114 203 191" // Main Menu button color
		"G_MainMenuButtonHover"		"208 24 24 240" // Main Menu hovered button color
		...
		"G_MainMenuShader" 			"75 75 75 99" // Main Menu shader color
		"G_BackpackItemBg"			"160 146 132 219" // Backpack item bg color
		"G_LoadoutItemBg"			"52 47 42 255" // Loadout item bg color
		"G_MenuBg"					"35 38 60 255" // Menu bg color
		...
		"G_ButtonBg"				"40 132 179 255" // Button bg color
		"G_ButtonText"				"214 206 200 255" // Button text color
		"G_ButtonHoverBg"			"182 51 49 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"78 15 14 255" // Button selected bg color
		...
		"TFOrange"			"156 64 62 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"156 64 62 255" // Highlight color
