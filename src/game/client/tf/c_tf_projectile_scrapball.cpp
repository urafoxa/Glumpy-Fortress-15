...
#include "cbase.h"
#include "c_tf_projectile_scrapball.h"
...
// Purpose: 
//-----------------------------------------------------------------------------
C_TFProjectile_ScrapBall::C_TFProjectile_ScrapBall( void )
{
	pEffect = NULL;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_TFProjectile_ScrapBall::OnDataChanged(DataUpdateType_t updateType)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_TFProjectile_ScrapBall::CreateTrails( void )
{
	if ( IsDormant() )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *C_TFProjectile_ScrapBall::GetTrailParticleName( void )
{
	if ( GetLauncher() )
	{
